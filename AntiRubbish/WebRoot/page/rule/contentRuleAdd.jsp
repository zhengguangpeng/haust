	...
	$(function() {
		...
		$("#senderFlag").change(function(){
			...
			if (flag =="0"){
				...
				var titleFlag = $("#titleFlag").val();
				if(receiverFlag =="1" && titleFlag=="1"){
					$("#regTip").hide();
				}
			}
		});
		...
		$("#receiverFlag").change(function(){
			...
			if (flag =="0"){
				...
				//如果另外两个也都是精确匹配
				var senderFlag = $("#senderFlag").val();
				var titleFlag = $("#titleFlag").val();
				if(senderFlag =="1" && titleFlag=="1"){
					$("#regTip").hide();
				}
		...
		$("#titleFlag").change(function(){
			...
			if (flag =="0"){
				...
				var receiverFlag = $("#receiverFlag").val();
				var senderFlag = $("#senderFlag").val();
				if(receiverFlag =="1" && senderFlag=="1"){
					$("#regTip").hide();
				}
		...
		$("#submitbtn").click(function(){ 
	                 ...
	                 //如果是内容规则,发件人/收件人/标题 不能同时为空
	                 if (type=="1" && (sender=="" && receiver=="" && title=="")) {
	                    alert("内容规则,发件人/收件人/标题 不能同时为空");
	                    $("#sender").focus();
	                    return;
	                 }
...
<span class="posNow"> 内容规则 >添加规则</span>
</div>
<div class="mainBox">
      <div class="p10 borderAll bg_F5F6FB">
        ...
        <span>
         	...
         	<span id="nameTip" style="display:none" ><font color="red">当前规则名称已经存在,请重新命名!</font></span>
        </span>
        </label>
        <!-- 
        ...
        <p style="height:20px"></p>    	
    	<label class="pr10">
        <span>发件人:<input style="width:400px" type="text"   id="sender" name="sender" /></span>
        ...
        <p style="height:20px"></p>
        <label class="pr10">
        <span>标题:<input style="width:400px" type="text"   id="title" name="title" /></span>
